...
import { LogOutIcon, UsersIcon, GlobeIcon, ActivityIcon, ShieldAlertIcon, CpuIcon, TerminalIcon } from 'lucide-react';
import {
      ...
      <div className="max-w-[1400px] mx-auto space-y-6 md:space-y-8">
        ...
        <header className="flex flex-col md:flex-row md:justify-between md:items-end gap-4 border-b border-border pb-6">
          <div>
            ...
            <p className="text-muted-foreground mt-2">Real-time global monitoring and security overview.</p>
          </div>
          <Button variant="outline" className="border-primary/50 text-primary hover:bg-primary/10" onClick={handleSignOut}>
